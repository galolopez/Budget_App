...
namespace Budget_App.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,ExpenseTF,HouseholdId")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,ExpenseTF,HouseholdId")] Category category)
        {
            if (ModelState.IsValid)
            {
